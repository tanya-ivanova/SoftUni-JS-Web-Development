class SmartHike {
    ...
    hike (peak, time, difficultyLevel) {
        ...
        let resourcesToBeUsed = time * 10;

        if(this.resources - resourcesToBeUsed < 0) {
            return "You don't have enough resources to complete the hike";
        } 

        this.resources -= resourcesToBeUsed;
    ...
    showRecord (criteria) {
        ...
        if(criteria === 'hard' || criteria === 'easy') {
            let searchedHikes = this.listOfHikes.filter(h => h.difficultyLevel === criteria);
