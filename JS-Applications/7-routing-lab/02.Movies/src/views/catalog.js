...
const catalogTemplate = (moviePromise) => html` <section
  id="home-page"
  class="view-section"
>
  <div
  ...
  <section id="add-movie-button" class="user">
    <a href="/create" class="btn btn-warning" id="add-btn">Add Movie</a>
  </section>
...
const movieCard = (movie) => html` <div class="card mb-4">
  <img
    class="card-img-top"
    src=${movie.img}
    alt="Card image cap"
