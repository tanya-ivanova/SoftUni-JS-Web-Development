function radioCrystals (input) {
    ...
    for (let i = 0; i < chunks.length; i++) {
        ...
        if (chunkSize === desiredThickness) {
            ...
            if ((chunkSize * 0.25 > 20) && (chunkSize * 0.20 > 20)) {
            ...
            } else if ((chunkSize * 0.25 > 20) && (20 > chunkSize * 0.20)) {
                while (chunkSize / 4 >= desiredThickness) {
                    chunkSize = chunkSize / 4;
                    counterCut++;
                }
                ...
                if (chunkSize === desiredThickness) {
                    ...
                    if (chunkSize === desiredThickness) {
                        ...
                        while (chunkSize - chunkSize * 0.20 >= desiredThickness) {
                            chunkSize = chunkSize - chunkSize * 0.20;
                            counterLap++;
                        }
                        if (counterLap > 0) {
                            console.log(`Lap x${counterLap}`);
